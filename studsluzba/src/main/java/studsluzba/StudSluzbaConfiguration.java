...
@Configuration
public class StudSluzbaConfiguration {

	/*
	 * 
	 * @Bean(name="studProgramService") public StudProgramService sampleService(){
	 * return new StudProgramService(); }
	 * 
	 * 
	 * @Bean(name="sifarniciService") public SifarniciService sifarniciService(){
	 * return new SifarniciService(); }
	 * 
